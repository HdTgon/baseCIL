...
class Learner(BaseLearner):
    ...
    def visual_adapter_train(self):
        ...
        self._network.update_fc(nb_classes=self._total_classes, sampling_features=sampled_data_list, nb_proxy=nb_proxy)
    ...
    def _eval_cnn(self, loader):
        ...
        for _, (_, inputs, targets) in enumerate(loader):
            ...
            with torch.no_grad():
                outputs, _ = self._network(inputs, zeroshot=True)
